...
class MainActivity : AppCompatActivity() {
    ...
    private val colorGreen       = Color.parseColor("#E8F5E9")
    private val colorGreenBorder = Color.parseColor("#C8E6C9")
    ...
    private fun applyShapes() {
        ...
        findViewById<LinearLayout>(R.id.btnHistory).background =
            GradientDrawable().apply {
                shape = GradientDrawable.RECTANGLE
                setColor(colorGreen)
                cornerRadius = 200f * density
                setStroke((1f * density).toInt(), colorGreenBorder)
            }
        ...
        historyThumbnail.background =
            GradientDrawable().apply {
                ...
                setStroke((1f * density).toInt(), Color.parseColor("#A5D6A7"))
            }
        ...
        imageFrame.background =
            GradientDrawable().apply {
                ...
                setStroke((3f * density).toInt(), colorRed)
            }
    ...
    private fun sendToGemini(base64Image: String) {
        runOnUiThread {
            resultText.text = "Analyzing your meal..."
